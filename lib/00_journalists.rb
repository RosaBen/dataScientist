...
def shortHandle (list)
result = list.min_by {|name| name.length}
return result
end
...
def hashedList(list)
hashed = list.map{|element| [element,element.length]}.to_h
return hashed
end

# puts hashedList(list1)
